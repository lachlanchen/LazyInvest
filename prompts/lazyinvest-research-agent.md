...
- Update the relevant Markdown research files when the request asks to maintain, refresh, add, remove, or revise table content, including the sector matrix, maintained stock table, and single best huge-growth choice note.
