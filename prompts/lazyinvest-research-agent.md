...
- Update the relevant Markdown research files when the request asks to maintain, refresh, add, remove, or revise table content, including the sector matrix, maintained stock table, single best huge-growth choice note, and best-choice history when relevant.
